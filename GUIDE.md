...
DocumentType: Guide
Title: EaC Identity Guide
Summary: Playbook for maintaining identity and access models in Everything-as-Code.
Created: 2025-11-20
Updated: 2025-11-20
Owners:
  - fathym
...
Steps for keeping identity EaC modules predictable and well-documented.

## Current Focus

- Maintain access configuration/right models and OAuth provider details (Azure, GitHub).
- Align with applications/runtime packages that consume identity info.
- Capture provider/version assumptions and change notes.

## Workflow

1. **Align scope** in [`README.md`](./README.md): clarify intended change (model update, provider change, release prep) and note target repo/branch if code moves.
