...
1. **Stay scoped.** Keep work under `projects/everything-as-code/eac-identity/`
...
3. **API stability.** Avoid breaking identity/access contracts silently;
...
5. **Security & privacy.** Do not embed secrets, tenant IDs, or PII in
   docs/tests; document required scopes/permissions clearly.
